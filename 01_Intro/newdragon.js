...
//   const sphereMat = new THREE.MeshBasicMaterial({map: skin, shininess: 150});
//   sphereMat.color.setHSL(i * 0.9, 1, 0.6);
  const myBall = new THREE.Mesh(sphereGeo, material);
...
const skin = new THREE.TextureLoader().load( '../dragonskin.jpg' );
